...
| `modalCuotas`, `modalUsuario`, `modalPagos`, `modalCambioCuota`, `confirmacionBajaAlta`, `confirmandoPago`, `confirmacionPago`, `confirmarGenerarPagos`, `resultadoGenerarPagos`, `generandoPagos`, `errorOperacion` | varios | Estados de modales (patrón dato \| null) |
...
| `ModalConfirmacion` | Baja/alta + generar pagos |
