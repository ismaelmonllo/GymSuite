 ...
 * /administradores/{id}:
 *   delete:
 *     summary: Eliminar administrador definitivamente
 *     description: Borrado físico del usuario. Solo admin. Para desactivar sin borrar usar PATCH /administradores/{id}/baja.
 *     tags: [Administradores]
 *     parameters:
 *       - in: path
 *         name: id
