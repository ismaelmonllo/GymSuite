...
const requisitos = [
  { texto: 'Mínimo 12 caracteres',    cumple: contrasena => contrasena.length >= 12 },
  { texto: 'Al menos una minúscula',  cumple: contrasena => /[a-z]/.test(contrasena) },
  { texto: 'Al menos una mayúscula',  cumple: contrasena => /[A-Z]/.test(contrasena) },
  { texto: 'Al menos un número',      cumple: contrasena => /[0-9]/.test(contrasena) },
